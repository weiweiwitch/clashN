...
public partial class MainWindow
{
    public MainWindow()
    {
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.OneWayBind(ViewModel, vm => vm.GetProfilesView, v => v.ProfilesTabItem.Content)
                .DisposeWith(disposables);
            this.OneWayBind(ViewModel, vm => vm.GetLogsView, v => v.LogsTabItem.Content).DisposeWith(disposables);
            this.OneWayBind(ViewModel, vm => vm.GetConnectionsView, v => v.ConnectionsTabItem.Content)
                .DisposeWith(disposables);
            ...
            this.OneWayBind(ViewModel, vm => vm.BlSystemProxyClear, v => v.MenuSystemProxyClear2.Visibility,
                conversionHint: BooleanToVisibilityHint.UseHidden,
                vmToViewConverterOverride: new BooleanToVisibilityTypeConverter()).DisposeWith(disposables);
            this.OneWayBind(ViewModel, vm => vm.BlSystemProxySet, v => v.MenuSystemProxySet2.Visibility,
                conversionHint: BooleanToVisibilityHint.UseHidden,
                vmToViewConverterOverride: new BooleanToVisibilityTypeConverter()).DisposeWith(disposables);
            this.OneWayBind(ViewModel, vm => vm.BlSystemProxyNothing, v => v.MenuSystemProxyNothing2.Visibility,
                conversionHint: BooleanToVisibilityHint.UseHidden,
                vmToViewConverterOverride: new BooleanToVisibilityTypeConverter()).DisposeWith(disposables);
            this.OneWayBind(ViewModel, vm => vm.BlSystemProxyPac, v => v.MenuSystemProxyPac2.Visibility,
                conversionHint: BooleanToVisibilityHint.UseHidden,
                vmToViewConverterOverride: new BooleanToVisibilityTypeConverter()).DisposeWith(disposables);
            this.BindCommand(ViewModel, vm => vm.SystemProxyClearCmd, v => v.MenuSystemProxyClear)
                .DisposeWith(disposables);
            ...
            this.BindCommand(ViewModel, vm => vm.SystemProxyNothingCmd, v => v.MenuSystemProxyNothing)
                .DisposeWith(disposables);

            this.OneWayBind(ViewModel, vm => vm.BlModeRule, v => v.MenuModeRule2.Visibility,
                conversionHint: BooleanToVisibilityHint.UseHidden,
                vmToViewConverterOverride: new BooleanToVisibilityTypeConverter()).DisposeWith(disposables);
            this.OneWayBind(ViewModel, vm => vm.BlModeGlobal, v => v.MenuModeGlobal2.Visibility,
                conversionHint: BooleanToVisibilityHint.UseHidden,
                vmToViewConverterOverride: new BooleanToVisibilityTypeConverter()).DisposeWith(disposables);
            this.OneWayBind(ViewModel, vm => vm.BlModeDirect, v => v.MenuModeDirect2.Visibility,
                conversionHint: BooleanToVisibilityHint.UseHidden,
                vmToViewConverterOverride: new BooleanToVisibilityTypeConverter()).DisposeWith(disposables);
            this.OneWayBind(ViewModel, vm => vm.BlModeNothing, v => v.MenuModeNothing2.Visibility,
                conversionHint: BooleanToVisibilityHint.UseHidden,
                vmToViewConverterOverride: new BooleanToVisibilityTypeConverter()).DisposeWith(disposables);
            ...
            this.OneWayBind(ViewModel, vm => vm.NotifyLeftClickCmd, v => v.TbNotify.LeftClickCommand)
                .DisposeWith(disposables);
        });
