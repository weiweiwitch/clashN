...
{
    public static async void UpdateSubscriptionProcess(bool blProxy, List<ProfileItem> profileItems,
        Action<bool, string> cbUpdateSubscription)
    {
        ...
        foreach (var item in profileItems)
        {
            ...
            else
            {
                ...
                var ret = ConfigHandler.AddBatchProfiles(result.Item1, indexId, groupId);
                if (ret == 0)
                {
